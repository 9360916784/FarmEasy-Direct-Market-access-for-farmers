	...
	<body>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FarmEasy Office<span>Karur</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+91 9360916784</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:k9346572kishore@gmail.com" style="color:white">FarmEasy@gmail.com</a></p>
			</div>
		</div>
